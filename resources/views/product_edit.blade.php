    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('product_update', ['id' => $product->id]) }}" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a class="btn btn-primary button_margin" href="{{ route('product_details', ['id' => $product->id]) }}">
                                    {{ __('戻る') }}
                                </a>
                            </div>
                        </div>
